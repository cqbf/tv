...
`2.` https://github.com/xisohi/CHINA-IPTV `来自xisohi/CHINA-IPTV，本地单播组播`  
`3.` https://github.com/suxuang/myIPTV  `移动专享,ipv6/v4`  
`4.` https://github.com/vbskycn/iptv/tree/master/tv   `来自`[`zbds.top`](https://zbds.top) `txt频道数量多于m3u`  
`5.` https://github.com/kimwang1978/collect-txt/blob/main/bbxx_lite.m3u  `来自`[`iptv365.org`](https://iptv365.org/)`大容量源`  
`6.` https://github.com/lalifeier/IPTV/blob/main/m3u/IPTV.m3u  `大容量源，关注地方频道/体育频道`  
`7.` https://gitee.com/zhanghuan12345/my-live  `gitee，多地直播源`  

`1.`http://218.1.210.177:3000/ `可用多，速度快，有体育。`  
`2.`https://raw.githubusercontent.com/jn950/live/main/tv/pllive.txt  `线路多，可用多，4K多。`  
`3.`https://codeberg.org/zxj/xyh/raw/branch/main/live.txt `台多，挺多可用`  
